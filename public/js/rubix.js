...
Rubix.prototype._setupAxis = function(animate) {
    ...
    if(this.opts.draw.grid) {
        ...
        this.xGridGroup.selectAll('.tick').style('stroke', this.opts.theme_style_color).style('opacity', 0.2);
    }
    ...
    if(this.master_detail) {
        ...
        this.xGridGroup2.selectAll('.tick').style('stroke', 'lightgray').style('opacity', 0.4);
    }
    ...
    if(this.opts.draw.grid) {
        ...
        this.yGridGroup.selectAll('.tick').style('stroke', this.opts.theme_style_color).style('opacity', 0.4);
    }
...
Rubix.prototype.callAxis = function(animate) {
    ...
    if(this.hasData) {
        ...
        if(this.opts.draw.grid) {
            this.xGridGroup.selectAll('path').style('stroke-width', 0);
            this.xGridGroup.selectAll('.tick').style('stroke', this.opts.theme_style_color).style('opacity', 0.4);
            this.yGridGroup.selectAll('path').style('stroke-width', 0);
            this.yGridGroup.selectAll('.tick').style('stroke', this.opts.theme_style_color).style('opacity', 0.4);
        }
    ...
    if(this.master_detail) {
        if(this.hasData) {
            ...
            if(this.xAxisGroup2) {
                this.xAxisGroup2.selectAll('line').attr('fill', 'none').attr('stroke', this.opts.theme_style_color).style('shape-rendering', 'crispEdges');
                this.xGridGroup2.selectAll('path').style('stroke-width', 0);
                this.xGridGroup2.selectAll('.tick').style('stroke', this.opts.theme_style_color).style('opacity', 0.4);
